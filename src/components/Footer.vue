  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-content">
        <div class="footer-section">
          ...
          <div class="contact-info">
            <div class="contact-item">
              ...
              <span>contato@gemsbiotec.com.br</span>
            </div>
            <div class="contact-item">
              <svg viewBox="0 0 24 24" class="icon">
                <path fill="currentColor"
        ...
        <div class="footer-section">
          ...
          <div class="links">
            ...
            <a href="#certificates">{{ translations.certificates }}</a>
            <a href="#publications">{{ translations.publications }}</a>
          </div>
        </div>
        ...
        <div class="footer-section">
          ...
          <div class="social-links">
            <a href="https://www.instagram.com/gemsbiotec/" target="_blank" class="social-link" title="Instagram">
            ...
            <a href="https://www.youtube.com/@GemsBiotec" target="_blank" class="social-link" title="YouTube">
              <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <title>YouTube</title>
                <path fill="currentColor"
      ...
      <div class="footer-bottom">
        <p>&copy; 2024 Gems Biotech. {{ translations.rights }}</p>
      </div>
    </div>
  </footer>
</template>
...
<style scoped>
.footer {
  background: linear-gradient(135deg, #115C8D 0%, #0774B3 100%);
  color: white;
  padding: 60px 0 0;
}
